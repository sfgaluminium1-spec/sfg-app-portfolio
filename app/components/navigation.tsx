...
import { LayoutDashboard, Building2, FileText, MessageSquare, Database, FolderOpen, Zap, DollarSign, Calendar, Search, Bell, Settings, User, Menu, X, Users, Brain, Shield, Eye, UserCheck, Truck, Wrench, UserCog, Hammer, ChevronDown, Cog, Factory, CreditCard, HardDrive } from 'lucide-react';
...
const navigationGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'SFG MEMORY', href: '/memory', icon: HardDrive, description: 'Persistent memory system for zero-drift orchestration', badge: 'NEW' }
    ]
  },
  {
